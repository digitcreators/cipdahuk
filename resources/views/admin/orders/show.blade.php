                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            ...
                            <dl class="row text-muted mb-0">
                                ...
                                <dt class="col-sm-3 text-right mb-0">Paper Topic:</dt>
                                <dd class="col-sm-9 mb-0">{{$order->paper_topic}}</dd>
                                ...
                                <dt class="col-sm-3 text-right mb-0">Number of Pages:</dt>
                                <dd class="col-sm-9 mb-0">{{$order->number_of_pages}}</dd>
                                <dt class="col-sm-3 text-right mb-0">Reference Style:</dt>
                                <dd class="col-sm-9 mb-0">{{$order->reference_style}}</dd>
