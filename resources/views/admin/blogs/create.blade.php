                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route("admin.blogs.store") }}" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <label class="required" for="meta_description">Meta_Description</label>
                                ...
                                {{-- <div class="mb-3 {{ $errors->has('tags') ? 'has-error' : '' }}">
                                    <label for="tag">Select Tag <small>(press <b>Ctrl</b> to select multiple)</small></label>
