...
class BlogController extends Controller
{
    ...
    {   
        ...
        return view('blogs.show', compact('blog', 'blogs', 'category', 'categories'));
    }
    ...
    public function category($slug)
    {
        ...
        return view('blogs.category',compact('blogs', 'categories', 'category'));
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('blogs.index', compact('blogs', 'query', 'categories'));
    }
