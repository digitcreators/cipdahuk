...
class ChangePasswordController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->back()->with('success', __('change_password_success'));
    }
    ...
    public function updateProfile(UpdateProfileRequest $request)
    {
        ...
        return redirect()->route('profile.password.edit')->with('message', __('update_profile_success'));
    }
    ...
    public function destroy()
    {
        ...
        return redirect()->route('login')->with('message', __('delete_account_success'));
    }
